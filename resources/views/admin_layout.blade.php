				...
				<div class="leftside-navigation">
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								<li><a href="{{URL::to('add_supplier')}}">Thêm danh mục thương hiệu</a></li>
								<li><a href="{{URL::to('all_supplier')}}">Liệt kê danh thương hiệu</a></li>                  
							</ul>
						</li>
						<li class="sub-menu">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								<li><a href="{{URL::to('all_order')}}">Quản lý đơn hàng</a></li>                  
							</ul>
						</li>
